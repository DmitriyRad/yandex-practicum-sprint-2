...
![Исправленное проксирование](img_11.png)

![Скриншот тестов](img_2.png)

![Теперь event пишет во все 3 топика](img_12.png)
...
Тут вернул imagePullSecrets:
dockerconfigjson: 
С секретом. Ранее убирал перед заливкой в gitHub. Из-за чего была ошибка. 
...
Поправил ответы от сервисов перепроверил тесты. Теперь все проходит четко.
![Тесты](img_14.png)
